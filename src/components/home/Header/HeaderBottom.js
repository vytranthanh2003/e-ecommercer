      ...
      <div className="max-w-container mx-auto">
        <Flex className="flex flex-col lg:flex-row items-start lg:items-center justify-between w-full px-4 pb-4 lg:pb-0 h-full lg:h-24">
          ...
          >
            ...
            <p className="text-[14px] font-normal">Mua sắm theo danh mục</p>
            {showCategoryMenu && (
              <motion.ul
              ...
              >
                {["Phụ kiện", "Nội thất", "Điện tử", "Quần áo", "Túi xách", "Đồ gia dụng"].map(
                  (category, index) => (
                    <li
                      key={index}
          ...
          <div className="flex gap-4 mt-2 lg:mt-0 items-center pr-6 cursor-pointer relative">
            <div onClick={() => setShowUserMenu(!showUserMenu)} className="flex">
              <FaUser />
              <FaCaretDown />
            </div>
            {showUserMenu && (
              ...
              >
                ...
                <Link onClick={() => setShowUserMenu(false)} to="/signup">
                  <li className="text-gray-400 px-4 py-1 border-b-[1px] border-b-gray-400 hover:border-b-white hover:text-white duration-300 cursor-pointer">
                    Đăng ký
                  </li>
                </Link>
